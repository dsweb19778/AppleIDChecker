...
def apple_api(email):  # Apple API
    ...
    if dead in post:
        ...
        fsadead.write("\n"+email)
        print(red+"    [DSWEB19778]"+" - "+str(time.ctime())+" - "+"Dead : "+str(email))
        ses.cookies.clear()
        ...
        fsavalid.write("\n"+email)
        print(green+"    [DSWEB19778]"+" - "+str(time.ctime())+" - "+"Live : "+str(email))
        ses.cookies.clear()
        ...
        fsalimit.write("\n"+email)
        print(yellow+"    [DSWEB19778]"+" - "+str(time.ctime())+" - "+"Lock : "+str(email))
        ses.cookies.clear()
